...
class MainController extends AbstractController
{
     ...
     * Display movie/serie
     * 
     * @param int $id Id of the movie to display
     * 
     * @Route("/movie/{id}", name="main_movie_show", requirements={"id"="\d+"})
     */
    public function movieShow($id, MovieRepository $movieRepository, CastingRepository $castingRepository)
    {
        // On va chercher le film demandé
